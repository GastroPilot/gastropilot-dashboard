        ...
        <div className="px-4 py-3 flex flex-col gap-3">
          <div className="flex items-center justify-between flex-wrap gap-3">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h1 className="text-2xl font-bold text-white">Menü-Verwaltung</h1>
        ...
        {filteredItems.length === 0 ? (
          ...
          <div>
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-xl font-semibold text-white">Artikel</h2>
            </div>
          ...
          <div className="space-y-4 px-4 md:px-6 pb-2">
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full px-3 py-2 bg-gray-800/50 border border-gray-600 rounded-md text-white placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                rows={2}
                disabled={loading}
            ...
            <div className="flex items-center">
              <label className="inline-flex items-center gap-3 px-3 py-2 rounded-md border border-gray-700 bg-gray-800 text-sm text-gray-100 cursor-pointer hover:border-blue-500">
                <input
                  type="checkbox"
                ...
                <div ref={categoryMenuRef} className="relative">
                  ...
                  {categoryMenuOpen && (
                    <div className="absolute left-0 right-0 mt-1 rounded-lg border border-gray-700 bg-gray-900 shadow-xl z-[60] max-h-[60vh] overflow-auto">
                      ...
                      >
                        Keine Kategorie
                        {!itemCategoryId && <Check className="w-4 h-4 text-blue-300" />}
                      </button>
                      {categories
