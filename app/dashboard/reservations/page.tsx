                ...
                >
                  ...
                  <div className="flex items-center gap-2">
                    <span className="px-2 py-1 rounded-full text-xs bg-gray-800">
                      {reservations.length + blocksForDayAll.length}
                    </span>
                    <span
                    ...
                    <div className="flex items-start justify-between gap-4">
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-3 mb-2">
                          ...
                          <div
                            className={`inline-flex items-center justify-center w-8 h-8 rounded-md border ${status.tone}`}
                          >
                            <status.Icon className="w-4 h-4" />
                          </div>
                          <div className="text-sm text-gray-400">
                            {getBlockTableLabel(block.id)}
                          </div>
                        </div>
