          ...
          <div className="flex items-center justify-between flex-wrap gap-3">
            ...
            <div className="flex items-center gap-2 pt-1.5 md:pt-2">
              <Button
                ...
                className="bg-muted border-input text-foreground shadow-none hover:text-primary hover:border-primary hover:shadow-[0_12px_32px_rgba(249,81,0,0.25)]"
              >
                <RefreshCw
      ...
      <div className="flex-1 overflow-y-auto p-4 md:p-6">
        {orders.length === 0 ? (
          <div className="flex flex-col items-center justify-center h-full text-center">
            ...
            <p className="text-muted-foreground">Alle Bestellungen sind abgearbeitet</p>
          </div>
        ) : (
    ...
    <div className="bg-card border border-border rounded-lg p-4 hover:border-input transition-colors">
      ...
      <div className="flex items-start justify-between mb-3">
          ...
          <div className="flex items-center gap-2 mb-1">
            {order.table && (
              <>
                ...
                <span className="font-semibold text-foreground">Tisch {order.table.number}</span>
              </>
            )}
            {!order.table && (
              <span className="font-semibold text-foreground">#{order.order_number || order.id}</span>
            )}
          </div>
        ...
        <div className="text-right">
          ...
          {order.party_size && (
            <div className="text-xs text-muted-foreground">{order.party_size} Pers.</div>
          )}
        </div>
      </div>
            ...
            <Button
              ...
              className={
                status === "in_preparation"
                  ...
                  : "bg-muted text-foreground border border-input shadow-none hover:bg-muted hover:border-input hover:text-foreground flex-1"
              }
            >
