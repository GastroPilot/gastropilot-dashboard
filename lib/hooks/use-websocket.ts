...
export function useWebSocket({
  ...
  }, [restaurantId, queryClient, addOrder, updateOrder, addReservation, updateReservation, removeReservation, updateTable, onMessage]);
  ...
  }, [getWsUrl, enabled, channels, handleMessage, onConnect, onDisconnect, onError, reconnectAttempts, reconnectInterval]);
