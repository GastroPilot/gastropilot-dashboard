...
export const API_BASE_URL =
  process.env.NEXT_PUBLIC_API_BASE_URL || process.env.API_BASE_URL || 'http://localhost:8001';
...
export const API_URL = cleanPrefix ? `${cleanBaseUrl}/${cleanPrefix}` : cleanBaseUrl;
